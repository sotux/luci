...
if hwtype == "atheros" or hwtype == "mac80211" or hwtype == "prism2" or vendor == "ralink" then
	...
	auth:depends({mode="sta", eap_type="fast", encryption="wpa-mixed"})
	...
	auth:depends({mode="sta-wds", eap_type="fast", encryption="wpa-mixed"})
	...
	identity:depends({mode="sta", eap_type="fast", encryption="wpa-mixed"})
	...
	identity:depends({mode="sta-wds", eap_type="fast", encryption="wpa-mixed"})
